...
ARGUMENT_HINTS: dict[str, str] = {
    ...
    "analyzebatch": "[--apply] [--allow-historical-edits] [--dry-run] (optional) plus free-form focus context",
    "clarify": "Optional areas to clarify in the spec",
    "clarifybatch": "[--apply] [--turn=N] (optional) plus free-form prioritization context",
